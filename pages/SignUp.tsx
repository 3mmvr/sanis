...
const SignUp: React.FC<SignUpProps> = ({ onSignup, onGoogleLogin, onLoginClick, onGuestContinue }) => {
    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <button className="btn-auth-google" type="button" onClick={onGoogleLogin}>
